...
const server = http.createServer((req, res) => {
    ...
    if(req.method == 'GET'){
        ...
        if(fileExt == '.html'){
            ...
            {
                console.log(`index 304: ${stationHQ.getProbabilities()[0]}`);
                console.log(`index 304: ${stationHQ.getProbabilities()[1]}`);
                console.log(`index 304: ${stationHQ.getProbabilities()[2]}`);
                res.statusCode = 200;
                res.setHeader('Content-Type', 'application/json');
